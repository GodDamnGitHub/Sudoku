  ...
  return (
    <View style={styles.container}>
      ...
      <MarkdownView>
        ...
        ![RN Logo](https://github.com/GodDamnGitHub/Sudoku/blob/CPA5/img/e01.png?raw=true =336x708){'\n'}
        ![RN Logo](https://github.com/GodDamnGitHub/Sudoku/blob/CPA5/img/e02.png?raw=true =336x708){'\n'}
        ![RN Logo](https://github.com/GodDamnGitHub/Sudoku/blob/CPA5/img/e03.png?raw=true =336x708){'\n'}
        ![RN Logo](https://github.com/GodDamnGitHub/Sudoku/blob/CPA5/img/e04.png?raw=true =336x708){'\n'}
        {'\n'}
        # Built With {'\n'}
          * React {'\n'}
          * React Native{'\n'}
